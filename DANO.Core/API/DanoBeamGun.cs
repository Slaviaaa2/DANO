namespace DANO.API
{
    ...
    public class DanoBeamGun : DanoWeapon
    {
        public BeamGun BeamGunBase { get; }

        internal DanoBeamGun(BeamGun beamGun) : base(beamGun) { BeamGunBase = beamGun; }
        ...
        public override string ToString() => $"DanoBeamGun({Name}, Launch={LaunchForce:F1}, Ammo={Ammo})";
    }
}
