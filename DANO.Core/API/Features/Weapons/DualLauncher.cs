namespace DANO.API
{
    ...
    public class DualLauncher : Weapon
    {
        ...
        internal DualLauncher(global::DualLauncher launcher) : base(launcher) { DualLauncherBase = launcher; }
        ...
        public override string ToString() => $"DualLauncher({Name}, Launch={LaunchForce:F1}, Ammo={Ammo})";
    }
}
