namespace DANO.API
{
    ...
    {
        public global::MeleeWeapon MeleeBase { get; }

        internal MeleeWeapon(global::MeleeWeapon melee) : base(melee) { MeleeBase = melee; }
        ...
        public override string ToString() => $"MeleeWeapon({Name}, BaseDmg={BaseAttackDamage:F1})";
    }
}
