...
namespace DANO.API
{
    ...
    public class LargeRaycastGun : Weapon
    {
        ...
        internal LargeRaycastGun(global::LargeRaycastGun gun) : base(gun) { LargeRaycastGunBase = gun; }
        ...
        public override string ToString() => $"LargeRaycastGun({Name}, Radius={BulletRadius:F2}, Ammo={Ammo})";
    }
}
